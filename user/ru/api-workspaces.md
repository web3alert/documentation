...
| Поле | Обязательное | Описание |
| --- | --- | --- |
| `url` | Да | URL загруженного avatar. То же значение сохраняется в `workspace.meta.avatar`. |
| `fileName` | Да | Имя сохраненного файла. |
| `extension` | Да | Расширение файла. |
| `size` | Да | Размер файла в байтах. |
| `workspace` | Да | Обновленный [WorkspaceView](types.md#workspaceview), включающий новые метаданные avatar. |
